...
- broader Ratchet controller/presentation fidelity beyond the recovered R&C1 run/jump/fall/crouch/facing/raw-stick slice, especially promotion of the recovered raw-byte shaping, the retail camera/control-heading source/follow policy and special traversal;
