...
- broader Ratchet controller/presentation fidelity beyond the recovered R&C1 run/jump/fall/crouch/facing/raw-stick slice, especially the exact translational walk/run selector, the retail camera/control-heading source/follow policy and special traversal;
